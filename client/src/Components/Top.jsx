...
function Top() {
    return (
        ...
        <div className='flex fixed z-50 w-full p-2 py-3 items-center justify-center gap-7 bg-white ' >
            <Link to={'/'}>
            ...
            <Link to={'/login'} className='flex items-center group gap-2 hover:bg-blue-600 hover:text-white p-[8px]  rounded-md '>
                ...
                <div className='z-40  bg-white shadow-2xl absolute top-12 hidden group-hover:grid group-hover:text-black p-3 px-4 -ms-3 gap-3 w-72 ' >
                    <SignUpDropDown />
                </div>
...
export const SignUpDropDown = () => {
    return (
        <>
            ...
            <Link className='flex gap-2 items-center' ><img src={WishLinkst} />WishList</Link>
            <Link className='flex gap-2 items-center' ><img src={Rewards} />Rewards</Link>
            <Link className='flex gap-2 items-center' ><img src={Gift} />Gift Cards</Link>
        </>
    )
}
