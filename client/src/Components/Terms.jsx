...
function Terms() {
  return (
    <div className='grid justify-center' >
      <LoginTop/>
      <div className='w-[978px] flex justify-center items-center bg-white px-[23px]'>
        <p>Flipkart Terms of Use
...
At Flipkart we are committed towards ensuring that disputes between sellers and buyers are settled amicably by way of the above dispute resolution mechanisms and procedures. However, in the event that a buyer wishes to contact the seller, he/ she may proceed to do so by accessing the seller related information made available by the sellers on their product listing pages. Alternatively, the buyers may also reach out to customer support at 044-45614700 or access help center at https://www.flipkart.com/helpcentre.</p>
      </div>
    </div>
  )
}
